"""
HunyuanImage V2 Full DiT model
Full 17B parameter DiT implementation
"""
...
class HunyuanImageV2FullDiT(nn.Module):
    """
    Full DiT model for HunyuanImage V2 (17B parameters)
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # Default configuration for full model
        if config is None:
            config = {
                "hidden_size": 1920,
                "num_layers": 48,
